<script lang="ts">
  ...
  const SHORTCUTS: [string, string][] = [
    ...
    ["Navigate todos", "↑ / ↓"],
    ["First / last todo", "Home / End"],
    ["One page up / down", "PageUp / PageDown"],
    ["Add one todo to the selection", "Ctrl+Click"],
    ["Select everything up to a todo", "Shift+Click"],
    ["Extend the selection with any move key", "Shift + move key"],
    ["Select all in the list", "Ctrl+A"],
